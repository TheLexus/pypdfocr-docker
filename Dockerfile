...
# install software
RUN sh -c "set -x \
	&& apt-get update && apt-get install -y locales curl python python-setuptools python-watchdog python-reportlab python-pil python-pypdf2 python-oauth2 python-oauth2client python-httplib2 tesseract-ocr tesseract-ocr-${T_LANG} ghostscript imagemagick poppler-utils\
